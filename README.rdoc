...
Thanks to Ryan Bates <a href="http://railscasts.com/episodes/193-tableless-model">Tableless Model Railscast</a>
and the  <a href="http://asciicasts.com/episodes/193-tableless-model.html for the inspiration">Tableless Model asciicast</a> .

There is an <a href="http://www.keithmcdonnell.net/">active_record-tableless_model introduction on Keith McDonnells ruby blog</a> . 
